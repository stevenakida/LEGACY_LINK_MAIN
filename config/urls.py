...
path('register/', views.register, name='register'),
    path('auth/google/login/', views.google_login_start, name='google_login'),
    path('auth/google/callback/', views.google_login_callback, name='google_login_callback'),
    path('terms/', views.terms, name='terms'),
    path('login/', views.login_view, name='login'),
    path('set-language/', views.set_language_web, name='set_language_web'),
    ...
    path('messages/attachment/<uuid:message_id>/', views.message_attachment_image, name='message_attachment_image'),
    path('messages/attachment/<uuid:message_id>/download/', views.message_attachment_download, name='message_attachment_download'),
    path('messages/attachment/<uuid:message_id>/report/', views.report_message_attachment, name='report_message_attachment'),
